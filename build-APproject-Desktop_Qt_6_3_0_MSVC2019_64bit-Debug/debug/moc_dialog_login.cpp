...
QT_MOC_LITERAL(13, 12), // "sendUserName"
QT_MOC_LITERAL(26, 0), // ""
QT_MOC_LITERAL(27, 15) // "on_okPB_clicked"

    },
    "Dialog_Login\0sendUserName\0\0on_okPB_clicked"
};
...
void Dialog_Login::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->sendUserName((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Dialog_Login::sendUserName)) {
                *result = 0;
                return;
            }
        }
...
, QtPrivate::TypeAndForceComplete<Dialog_Login, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<QString, std::false_type>
...
void *Dialog_Login::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "customers"))
        return static_cast< customers*>(this);
...
// SIGNAL 0
void Dialog_Login::sendUserName(QString _t1)
{
